...
<div class="topnav">
  <a class="active" href="firstpage">Home</a>
  ...
  <div class="login-container">
    <form action="" method="POST">
      ...
      <input type="password" placeholder="Password" name="password_1" style="width: 130px; height: 34px;font-size: 16px; margin-right: 4px;">
